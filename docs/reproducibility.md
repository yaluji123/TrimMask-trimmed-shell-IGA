...
The trapezoid and triangular benchmark CSVs retain their 2026-07-13 Release
runs. The complex-perforated-plate CSVs were regenerated on 2026-08-03 after
correcting the automatic resolution and excluding the natural parameter-frame
outer loop from cut-cell classification. All benchmarks use the automatically
generated starting resolution before the three quadrature strategies are
...
Version 1.2.2 provides the files needed to reproduce two engineering-scale
comparisons:
